...
#[cfg(feature = "cuda")]
use candle::{CpuStorage, Layout, Shape, Storage};
#[cfg(feature = "cuda")]
...
// Re-export Activation from cudarc
#[cfg(feature = "cuda")]
            ...
            #[cfg(feature = "cuda")]
            {
                ...
                CUBLASLT = driver::result::init()
                    ...
                    .and_then(|device| match device {
                        Device::Cuda(_) => CublasLt::new(&device)
                            .ok()
                            .map(|cublaslt| CublasLtWrapper { cublaslt }),
                        _ => None,
                    });
            }
        });
...
// ============================================================================
// Ported code from candle_cublaslt crate
// ============================================================================
